...
### 1. 로그인 안내
- **일반 사용자 (학생/교사):** 메인 화면 중앙의 `[구글 계정으로 1초만에 시작하기]` 버튼을 눌러 로그인해야 모든 웹앱을 열람하고 실행할 수 있습니다.
- **관리자:** 로그인 후 상단의 `[관리자]` 버튼을 클릭하고, 관리자 전용 인증 코드(`admin1234`)를 입력하면 앱 추가 및 관리 페이지로 접근할 수 있습니다.
